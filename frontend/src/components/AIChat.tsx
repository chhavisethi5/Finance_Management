...
export default function AIChat() {
  ...
  return (
    <div className="flex h-[calc(100vh-12rem)] flex-col rounded-2xl border border-[#2d3348] bg-[#1e2235] shadow-card overflow-hidden">
      {/* Header */}
      <div className="flex items-center gap-3 border-b border-[#2d3348] bg-[#1a1d27]/40 px-6 py-4">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        {messages.length === 0 ? (
          <div className="flex h-full flex-col items-center justify-center text-center max-w-md mx-auto px-4">
            ...
            <div className="mt-6 w-full space-y-2.5">
              {suggestionChips.map((chip, idx) => (
                <button
                  ...
                  className="w-full rounded-xl border border-[#2d3348] bg-[#252a3e]/40 px-4 py-2.5 text-left text-xs font-medium text-[#94a3b8] hover:border-[#4f8ef7]/40 hover:bg-[#252a3e] hover:text-[#4f8ef7] transition-all"
                >
                  💡 {chip}
                </button>
              ))}
      ...
      <form
        ...
        className="flex items-center gap-2 border-t border-[#2d3348] bg-[#1a1d27]/20 p-4"
      >
        <input
          type="text"
          value={input}
          ...
          className="flex-1 rounded-xl border border-[#2d3348] bg-[#252a3e] px-4 py-3 text-xs text-[#f1f5f9] placeholder-[#475569] outline-none focus:border-[#4f8ef7] focus:ring-1 focus:ring-[#4f8ef7]/40 transition-all disabled:opacity-50"
        />
        <button
          type="submit"
          disabled={!input.trim() || loading}
          className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#4f8ef7] to-[#6c63ff] text-white shadow-lg shadow-[#4f8ef7]/15 hover:opacity-90 active:scale-95 transition-all disabled:pointer-events-none disabled:opacity-40"
        >
